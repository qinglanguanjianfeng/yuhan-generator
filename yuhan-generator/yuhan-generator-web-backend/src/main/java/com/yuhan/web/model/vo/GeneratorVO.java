package com.yuhan.web.model.vo;
...
public class GeneratorVO implements Serializable {
    ...
    public static Generator voToObj(GeneratorVO generatorVO) {
        ...
        Meta.FileConfigDTO fileConfigDTO = generatorVO.getFileConfig();
        generator.setFileConfig(JSONUtil.toJsonStr(fileConfigDTO));
        Meta.ModelConfigDTO modelConfigDTO = generatorVO.getModelConfig();
        generator.setModelConfig(JSONUtil.toJsonStr(modelConfigDTO));
